...
export function ResistSection({ riddle }: { riddle: string | null }) {
    ...
    <>
      ...
      {screenFlash && (
        <div
          style={{
            ...
            zIndex: 80,
            background: '#ef4444',
            animation: 'rs-screen-flash 700ms ease-out forwards',
          }}
        />
      )}
      ...
      <div
        style={{
          ...
          alignItems: 'center',
          gap: '8px',
          animation: shaking ? 'rs-shake 0.6s ease-out forwards' : 'none',
        }}
      >
        {phase === 'mash' && (
          <div
            style={{
              ...
              height: '96px',
              animation: glitching
                ? 'rs-card-glitch 900ms ease-out forwards'
                : draining
                ? 'none'
                : 'rs-breathe 2.2s ease-in-out infinite',
            }}
          >
            <svg
              width="96"
            ...
            <div
              ...
              style={{
                ...
                pointerEvents: 'none',
                animation: rippleKey > 0 ? 'rs-ripple 0.5s ease-out forwards' : 'none',
              }}
            />
        ...
        {phase === 'riddle' && (
          ...
          >
            ...
            />
            {riddleError && (
              <span style={{ fontSize: '10px', color: 'rgba(239,68,68,0.80)' }}>
                {riddleError}
              </span>
            )}
            <button
